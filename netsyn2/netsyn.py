...
def runBox(nameBox, resultsDirectory, analysisNumber, ORDERBOX, args):
    ...
    if nameBox == 'GetINSDCFiles':
        ...
        netsyn_parseINSDCFiles_GetTaxonomy.run(inputBoxII, args.IncludedPseudogenes)
        ...
        netsyn_clusteringIntoFamilies.run(fasta, proteins, args.Identity, args.Coverage, args.MMseqsAdvancedSettings)
